  ...
  return (
    <div className="relative" ref={dropdownRef}>
      <motion.button
        ...
        className="w-auto group relative flex items-center gap-2 px-3 py-1.5 bg-[#1e1e2e]/80 hover:bg-[#262637] 
      ...
      >
        ...
        <span className="text-gray-300 text-[14px] min-w-[80px] text-left group-hover:text-white transition-colors">
          {currentTheme?.label}
        </span>
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            backdrop-blur-xl rounded-xl border border-[#313244] shadow-2xl py-2 px-2 z-50"
          >
            ...
            {THEMES.map((t, index) => (
              <motion.button
                ...
                className={`
                relative group w-full flex items-center gap-3 px-3 py-1.5 hover:bg-[#262637] transition-all duration-200 hover:rounded-lg
                ${
                  theme === t.id
              ...
              group-hover:opacity-100 transition-opacity"
                ...
                <div
                  className={`
                flex items-center justify-center size-5 rounded-lg
                ${
                  theme === t.id
                    ? "bg-blue-500/10 text-blue-400"
              ...
              `}
                ...
                {/* label */}
                <span className="flex-1 text-[14px] text-left group-hover:text-white transition-colors">
                  {t.label}
                </span>
